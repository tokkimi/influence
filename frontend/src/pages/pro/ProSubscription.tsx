...
export default function ProSubscription() {
  ...
  return (
    <div style={{ maxWidth: '800px' }}>
      <h1 style={{ fontFamily: 'Georgia, serif', fontSize: '1.8rem', fontWeight: 400, color: '#1a1a1a', marginBottom: '0.5rem' }}>Abonnement</h1>
      <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', fontSize: '0.85rem', color: '#9e8e7e', marginBottom: '3rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
        {/* Free */}
        <div style={{ border: '1px solid #e8d5b7', padding: '2rem', backgroundColor: 'white' }}>
        ...
        {/* Premium */}
        <div style={{ border: '2px solid #c9a96e', padding: '2rem', backgroundColor: 'white', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '2rem' }}>
            {[
              ...
              'Profil boutique complet avec bannière',
