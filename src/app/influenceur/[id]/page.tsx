    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-sm mb-6">
          ...
          <div className="px-8 pb-6">
            ...
            <div className="flex items-center gap-3 flex-wrap mb-3">
              ...
              {inf.country && <span className="text-xs text-gray-500 flex items-center gap-1"><MapPin className="w-3 h-3" />{inf.country}</span>}
              {inf.subscription === 'PRO' && <span className="text-xs bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-full font-medium">⭐ Pro</span>}
            </div>
            <p className="text-gray-600">{inf.bio}</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {/* Tarifs */}
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <h2 className="font-semibold text-gray-900 mb-3">Tarifs</h2>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between"><span className="text-gray-500">Post / Photo</span><span className="font-semibold">{inf.ratePost}€</span></div>
              <div className="flex justify-between"><span className="text-gray-500">Story</span><span className="font-semibold">{inf.rateStory}€</span></div>
              <div className="flex justify-between"><span className="text-gray-500">Vidéo / Reel</span><span className="font-semibold">{inf.rateVideo}€</span></div>
            </div>
          </div>

          {/* Langues */}
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <h2 className="font-semibold text-gray-900 mb-3 flex items-center gap-2"><Globe className="w-4 h-4" />Langues</h2>
            <div className="flex flex-wrap gap-2">
          ...
          {/* Communauté */}
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <h2 className="font-semibold text-gray-900 mb-3">Audience</h2>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between"><span className="text-gray-500">Femmes</span><span className="font-semibold">72%</span></div>
              <div className="flex justify-between"><span className="text-gray-500">Hommes</span><span className="font-semibold">28%</span></div>
              <div className="flex justify-between"><span className="text-gray-500">25-34 ans</span><span className="font-semibold">42%</span></div>
              <div className="flex justify-between"><span className="text-gray-500">France</span><span className="font-semibold">68%</span></div>
            </div>
          </div>
        </div>
      </div>
