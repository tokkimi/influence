    ...
    <>
      ...
      <div className="pt-16">
        <div className="bg-hero-gradient py-16 text-center">
          ...
          <p className="text-white/80 text-lg max-w-xl mx-auto">Une plateforme simple et transparente pour créer des collaborations authentiques entre marques et influenceurs</p>
        </div>
        <HowItWorks />

        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="font-display text-3xl font-bold text-gray-900 mb-4">Prêt à démarrer ?</h2>
