  ...
  return (
    <section className="bg-[#0f0f0f] py-16 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-px bg-gradient-to-r from-transparent via-[#f97316]/40 to-transparent" />
        <div className="absolute -top-20 right-0 w-[300px] h-[300px] rounded-full opacity-10" style={{background:'radial-gradient(circle, #f97316 0%, transparent 70%)'}} />
      </div>
      <div className="relative max-w-2xl mx-auto px-5 text-center">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-[#f97316] mb-3">Newsletter</p>
        ...
        {done ? (
          ...
          <form onSubmit={handleSubmit} className="flex gap-2 max-w-md mx-auto">
            ...
            <button type="submit" className="flex items-center gap-2 px-5 py-3 rounded-full text-sm font-semibold text-white flex-shrink-0" style={{background:'#f97316'}}>
